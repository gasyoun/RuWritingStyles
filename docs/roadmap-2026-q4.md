...
- **C1.2 — Passport builds (gated on C1.1).** Once texts land, the five orientalist passports
  ...
  **Progress 23-08-2026: Bartold ([H3381](https://github.com/gasyoun/Uprava/blob/main/handoffs/README.md)) and Turaev ([H3382](https://github.com/gasyoun/Uprava/blob/main/handoffs/H3382-OxAlpha_RuWritingStyles_turaev-passport-build_23.08.26.md)) built and corpus-grounded — 2 of 5; Golenishchev and Krachkovsky buildable next, Shileiko stays gated.**
