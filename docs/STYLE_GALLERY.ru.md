...
Всего стилей: **48**. Регенерируется: `python tools/generate_style_gallery.py`.

## Отдельные стили (по школам/кластерам)

### Индология (санскритология)

- [Елизаренкова-веда](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/elizarenkova-veda-style.md) — `elizarenkova-veda`
...
- [Albedil-Sbornik](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/albedil-sbornik-style.md) — `albedil-sbornik`
- [Казанский](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/kazanskiy-korpus-style.md) — `kazanskiy-korpus`
- [Лидова](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lidova-commentary-style.md) — `lidova-commentary`
- [Зализняк-энклитики](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/zalizniak-enklitiki-style.md) — `zalizniak-enklitiki`
- [Зализняк-именное](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/zalizniak-imennoe-style.md) — `zalizniak-imennoe`

### Нормативно-стилистическая школа

- [Зализняк-школьников_1](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/zalizniak-shkolnikov_1-style.md) — `zalizniak-shkolnikov-1`

### Историко-культурная школа
...
- [В. С. Голенищев](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/golenishchev-style.md) — `golenishchev`
- [И. Ю. Крачковский](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/krachkovskij-style.md) — `krachkovskij`
- [Б. А. Тураев](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/turaev-style.md) — `turaev`

## Школы целиком (кластерные стили)

Сводные паспорта школ — применяют метод школы, а не одного автора.

- [Стиль: Индология (санскритология) — кластерный профиль](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/indology-style.md) — `indology`
- [Базовый стиль: Диалектологически-Социолингвистическая Школа (ДСШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_dss-style.md) — `ling_dss`
- [Базовый стиль: Историко-этимологическая школа (ИЭШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_iesh-style.md) — `ling_iesh`
- [Базовый стиль: Когнитивно-Метафорическая Школа (КМШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_kmsh-style.md) — `ling_kmsh`
- [Базовый стиль: Московская Семантическая Школа (МСШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_mss-style.md) — `ling_mss`
- [Базовый стиль: Московско-Тартуская семиотическая школа (МТШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_mts-style.md) — `ling_mts`
- [Базовый стиль: Нормативно-Стилистическая Школа (НСШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_nss-style.md) — `ling_nss`
- [Базовый стиль: Петербургская Функциональная Грамматика (ПФГ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_pfg-style.md) — `ling_pfg`
- [Базовый стиль: Типологическая Школа (ТШ)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/ling_tsh-style.md) — `ling_tsh`
- [Базовый стиль: Бахтинская школа](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lit_bakhtin-style.md) — `lit_bakhtin`
- [Базовый стиль: Историко-культурная школа](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lit_historico_cultural-style.md) — `lit_historico_cultural`
- [Базовый стиль: Мифопоэтика](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lit_mythopoetics-style.md) — `lit_mythopoetics`
- [Базовый стиль: Нарратология](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lit_narratology-style.md) — `lit_narratology`
- [Базовый стиль: ОПОЯЗ (Общество изучения поэтического языка)](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lit_opoyaz-style.md) — `lit_opoyaz`
- [Базовый стиль: Постструктурализм](https://github.com/gasyoun/RuWritingStyles/blob/main/ClaudeStyles/lit_poststructural-style.md) — `lit_poststructural`
