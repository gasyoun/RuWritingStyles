...
> **АРХИВ (помечено 2026-07-03, фаза R2).** Фазы 0–4 выполнены; документ сохранён как
...
(грамматика санскрита, самасы). Остаётся пополнить приватный корпус опорными
...
**Статус (2026-06-13): кейсы и протокол готовы; ждёт платного прогона.** В
