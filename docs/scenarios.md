...
4. Выберите провайдера. Для безопасной проверки интерфейса используйте `mock`; для содержательного аудита — настроенный real provider (основной — `deepseek`; также `openai`, `google`, `anthropic`, `openrouter`, `local`, `ollama`).
