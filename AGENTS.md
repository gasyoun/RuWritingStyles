...
- **Eval-Centricity**: Любое изменение в логике должно проверяться через `eval-suite`; текущий manifest содержит 55 кейсов, из которых 6 детерминированно проходят на mock, а MVP-набор содержит 6 стилей.
